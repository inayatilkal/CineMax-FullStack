  ...
  return (
    <div className='flex flex-col justify-between p-3 bg-gray-800 rounded-2xl hover:-translate-y-1 transition duration-300 w-70'>
      ...
      <p className='text-sm text-gray-400 mt-2'>
       ...
       {movie.minPrice && (
        <p className='flex items-center gap-1 text-sm text-gray-300 font-medium pt-1'>
          {currencyFormat(movie.minPrice)}
        </p>
      )}
      ...
      <div className='flex items-center justify-between mt-2 pb-3'>
        ...
        <p className='flex items-center gap-1 text-sm text-gray-400 mt-1 pr-1 ml-1'>
